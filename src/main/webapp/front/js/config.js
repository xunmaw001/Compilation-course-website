...
var centerMenu = [
    ...
    ,{
        name: '汇编知识收藏',
        url: '../huibianzhishiCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '汇编知识',
        url: './pages/huibianzhishi/list.html'
    },

]

var adminurl =  "http://localhost:8080/huibiankechengwangzhan/admin/dist/index.html#/login";

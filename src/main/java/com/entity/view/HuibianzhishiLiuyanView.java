...
public class HuibianzhishiLiuyanView extends HuibianzhishiLiuyanEntity implements Serializable {
	...
	public HuibianzhishiLiuyanView() {

	}

	public HuibianzhishiLiuyanView(HuibianzhishiLiuyanEntity huibianzhishiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, huibianzhishiLiuyanEntity);
